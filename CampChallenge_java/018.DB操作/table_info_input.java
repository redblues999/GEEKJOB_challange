 ...
 * @author redblues
 */
public class table_info_input extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            db_st = db_con.prepareStatement("insert into profiles(profilesID,name,tell,age,birthday) VALUES (6, '佐藤 達也', '03-1234-5678', 24, '2000-2-17')");
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet table_info_input</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("</body>");
            out.println("</html>");
